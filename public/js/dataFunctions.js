...
$('#delete-category-flavour').on('show.bs.modal',function (event){
    var button = $(event.relatedTarget)
    var flavour_id = button.data('flavourid');
    var modal = $(this)
    modal.find('.modal-body #category_flavour_id').val(flavour_id);
})
$('#delete-category-size').on('show.bs.modal',function (event){
    var button = $(event.relatedTarget)
    var size_id = button.data('sizeid');
    var modal = $(this)
    modal.find('.modal-body #category_size_id').val(size_id);
})
