...
<html lang="en">
	<head>
		...
		<title>Scoops Ready {{count($my_processed_orders)}}</title>
		...
		<div id="navbar" class="navbar navbar-default    navbar-collapse       ace-save-state">
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-header pull-left">
				 ...
				 <input type="hidden" id="my_old_orders" value="{{$my_old_orders}}">
      			 <input type="hidden" id="my_new_orders" value="{{$my_new_orders}}">
