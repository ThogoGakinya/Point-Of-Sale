		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar responsive ace-save-state">
				...
				<ul class="nav nav-list">
                    ...
                    <li class="">
					   <a href="{{ route('admin_change_status',1)}} ">
					...
					<li class="">
                        <a href="{{ route('admin_change_status',2)}} ">
					...
					<li class="">
                        <a href="{{ route('admin_change_status',3)}} ">
					...
					<li class="">
                        <a href="{{ route('admin_change_status',4)}} ">
...
<script type="text/javascript">
	jQuery(function($) {
		...
		var myTable = 
		$('#dynamic-table , #dynamic-table1, #dynamic-table2, #dynamic-table3 , #dynamic-table4')
