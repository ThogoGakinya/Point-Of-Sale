...
<head>
	<title>Scoops</title>
    <link rel="stylesheet" href="{{asset('css/welcome_landing.css')}}" />
...
<body style="background-image: url('{{asset('assets/images/mojito/Scoops_POS_Landing.png')}}');">
	<div class="container h-100">
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				<div class="d-flex justify-content-center">
					<div class="brand_logo_container">
						<img src="{{asset('assets/images/mojito/p2.png')}}" class="brand_logo" alt=" Scoops Logo">
					</div>
				</div>
