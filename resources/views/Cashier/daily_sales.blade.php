       ...
       {{date("l jS \of F Y h:i:s A")}}  
            ...
            <div class="tabbable" style="background-color: #ffffff;">
                <ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
                    ...
                    <li>
                        <a data-toggle="tab" href="#items">ITEMIZED SALES&nbsp;<span class="badge badge-warning">{{count($items)}}</span></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#waiters">WAITERS&nbsp;<span class="badge badge-warning">{{count($waiters)}}</span></a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#waiters">EXPENSES&nbsp;<span class="badge badge-warning">{{$total_expenses}}</span></a>
                    </li>
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->amount}}</td>
                                     <td>{{$item->quantity}}</td>
                                    <td>
                                      <a href="{{route('product_daily',$item->product_id)}}" class="btn btn-success btn-xs">View<i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                                @php
                                $cnt ++;
